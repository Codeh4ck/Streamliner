...
public abstract class BlockBase : Runnable, IBlock
{
    ...
    private void StartFlow()
    {
        ...
        {
            if (AuditLogger == null)
                _processingTasks[x] = new(Process, _cancellationToken, TaskCreationOptions.LongRunning);
            else
                _processingTasks[x] = new(ProcessWithAuditing, _cancellationToken, TaskCreationOptions.LongRunning);
